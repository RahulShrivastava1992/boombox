package com.example.rttac.util;
...
public abstract class SystemUiHider {
	 ...
	 * activity layout. This is most useful when there are no controls at the top of
	 * the activity layout.
	 * <p>
	 * This flag isn't used on newer devices because the
	 * <a href="http://developer.android.com/design/patterns/actionbar.html">action
	...
	/**
	 * Creates and returns an instance of {@link SystemUiHider} that is appropriate
	 * for this device. The object will be either a {@link SystemUiHiderBase} or
